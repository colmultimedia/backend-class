...
app.use(session({
  store: mongoStore.create({
    mongoUrl: "mongodb+srv://coladmin:mosorio12@cluster0.kduye.mongodb.net/desafio36?retryWrites=true&w=majority",
...
function connectDB() {
    ...
    try{
       mongoose.connect("mongodb+srv://coladmin:mosorio12@cluster0.kduye.mongodb.net/desafio36?retryWrites=true&w=majority",
         {
